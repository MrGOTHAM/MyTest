...
public class Scan extends ActivityBase {
    /**
     * 扫描结果监听
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Scan的布局设置
        setContentView(comt.example.dell_pc.test.R.layout.scan);
        //透明状态栏，透明导航栏
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new Scan.CaptureActivityHandler();
        }
    }
    ...
    final class CaptureActivityHandler extends Handler {
        ...
        Scan.DecodeThread decodeThread = null;
        private Scan.State state;

        public CaptureActivityHandler() {
            decodeThread = new Scan.DecodeThread();
            decodeThread.start();
    ...
    final class DecodeThread extends Thread {
        ...
        public void run() {
            Looper.prepare();
            handler = new Scan.DecodeHandler();
